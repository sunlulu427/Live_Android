 ...
 * - For the publishing view, see [LivePushScreenActivity].
 */
class LivePushScreenEnterActivity : MLVBBaseActivity() {
    ...
    private fun setupDescriptionText() {
        ...
        val urlEnd = text.indexOf("56595") + 5

        if (urlStart != -1 && urlEnd > urlStart) {
            spannableString.setSpan(
                URLSpan("https://cloud.tencent.com/document/product/454/56595"),
                urlStart,
                urlEnd,
    ...
    private fun startPushCamera(type: Int) {
        ...
        if (streamId.trim().isEmpty()) {
            ...
            val intent = Intent(this, LivePushScreenActivity::class.java).apply {
