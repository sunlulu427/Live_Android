 ...
 */
class LivePKEnterActivity : MLVBBaseActivity() {
    companion object {
        ...
        mButtonNext.setOnClickListener {
            when (mStateInput) {
                ...
                STEP_INPUT_ROLE -> {
                    ...
                    mButtonNext.setText(
                        if (mRoleSelected == ROLE_ANCHOR) R.string.livepk_rtc_push else R.string.livepk_webrtc_play
                    )
                ...
                STEP_INPUT_STREAM -> {
                    ...
                    val targetClass = if (mRoleSelected == ROLE_ANCHOR) {
                        LivePKAnchorActivity::class.java
                    } else {
                        LivePKAudienceActivity::class.java
                    }

                    val intent = Intent(this@LivePKEnterActivity, targetClass)
